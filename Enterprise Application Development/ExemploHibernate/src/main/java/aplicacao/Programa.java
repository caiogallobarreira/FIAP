...
public class Programa {
	...
	public static void main(String[] args) {
		/*
		 * O EntityManagerFactory eh uma classe factory utilizado para instanciar 
		 * objetos do tipo EntityManager
		 */
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("pacientes");
		
		/*
		 * O EntityManager eh uma classe que abriga a conexao com o banco de dados e nos da
		 * acesso a metodos para CRUD em entidades no banco de dados. 
		 */
		 ...
		 * SELECT FROM ID
		 */
		Paciente pacienteSelectId = em.find(Paciente.class, 7);
		System.out.println(pacienteSelectId);
		 ...
		 * DELETE
		 */
		// Paciente pacienteDelete = em.find(Paciente.class, 25);		
		// em.getTransaction().begin();
